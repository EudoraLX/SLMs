...
class DatabaseHelper {
  ...
  Future<int> addServer(Server server) async {
    ...
    final result = await conn.query(
      '''
      INSERT INTO servers (
        serial_number, model, manufacturer_id, specifications, purchase_cost,
        selling_price, quantity, location_id, supplier_id, warranty_id, status_id,
  ...
  Future<void> updateServer(Server server) async {
    ...
    await conn.query(
      '''
      UPDATE servers SET
        serial_number = ?, model = ?, manufacturer_id = ?, specifications = ?,
        purchase_cost = ?, selling_price = ?, quantity = ?, location_id = ?,
        supplier_id = ?, warranty_id = ?, status_id = ?, assembly_date = ?,
  ...
  Future<List<Server>> getServers() async {
    ...
    return results.map((row) {
      ...
      return Server(
        ...
        warrantyId: row['warranty_id'] as int,
        warrantyName: row['warranty_name'] as String?,
        statusId: row['status_id'] as int,
